...
public class DateUtils {
    ...
    public static String currentDateTime() {
        ...
        final String format1 = dateTimeFormatter.format(now);
        return format1;
    }
    ...
    /**
     * 根据开始日期和增加天数返回一个日期列表（包含开始日期）
     * 如果减少天数：请使用calendar.add(Calendar.DAY_OF_MONTH, -i);
     * @param startDate 开始日期
     * @param days 增加的天数
     * @return
     */
    public static List<String> getListDate(String startDate,Integer days){
        try{
            ...
            for (int i = 1; i < days; i++){
                ...
                //将日期添加到日期列表
                listDates.add(sdf.format(calendar.getTime()));
            }
            return listDates;
        }catch (Exception e){
            return null;
     ...
     * @return
     */
    public static List<String> getListDate2(String startDate,Integer days){
        try{
            List<String> listDates = new ArrayList<>();
            //获取日历实例
            Calendar calendar = Calendar.getInstance();
    ...
    /**
     *
     * @Description: 当前时间到凌晨的剩余时间，秒
     * @auther: Sakura
     * @date: 2019/5/13 14:36
     * @param: []
     * @return: long
     */
    public static long currentRemainingTime() {
...
//            List<String> listDates = getListDate("2019-04-30", 1);
//            for(String date : listDates) {
//                System.out.println("转换出来的日期："+date);
//            }
        } catch (Exception e) {
            throw new Exception();
        }
